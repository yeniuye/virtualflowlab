// This is the header file primitive.h
...
public:
   ...
   void calculateArcDefPointCoor();
	...
	// cuneyt: attachedBlock, attachedFace ve isThereSecondBlock degiskenlerinin burada olmamasi daha mi uygun?
