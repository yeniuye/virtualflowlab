// This is the header file problem.h
// This is the interface for the class Problem.
...
private:
   ...
   string defaultFileName; // A file called DEFAULT.txt that has the problem name in it. It is needed for the standalone solver.
	...
	int meshGenerationAlgorithm;  // 0: TFI Linear, 1: ..... cuneyt: burayi tamamla
